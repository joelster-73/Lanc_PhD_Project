...
from src.methods.magnetosheath_saturation.plot_space_time import plot_sc_years, plot_sc_orbits
...
plot_compare_sc_omni(df_omni, df_merged, param, *responses, restrict=True,  data_type=data_type, data1_name=param_names.get(param,param), data_name_map = param_names)

plot_sc_years(sw_dir, sc_keys=sc_keys, combined=False, data_type=data_type, region='sw')
plot_sc_orbits(sw_dir, sc_keys=sc_keys, data_type=data_type, region='sw')
