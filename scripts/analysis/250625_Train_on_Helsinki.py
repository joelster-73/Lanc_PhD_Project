...
for vary in ('dist_buff','min_ratio'):
    ...
    plot_single_param_vary(vary_array, slopes_fit=slope_fits, counts=num_shocks, slopes_R2=slope_R2s, ind_var=vary, title_info_dict={'buffer_up': buffer_up, 'buffer_dw': buffer_dw, 'dist_buff': distance_buff})
